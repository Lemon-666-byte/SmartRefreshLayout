...
import com.refreshview.api.DefaultRefreshFooterCreator;
import com.refreshview.api.DefaultRefreshHeaderCreator;
import com.refreshview.api.RefreshContent;
import com.refreshview.api.RefreshFooter;
import com.refreshview.api.RefreshHeader;
import com.refreshview.api.RefreshInternal;
import com.refreshview.api.RefreshKernel;
import com.refreshview.api.RefreshLayout;
import com.refreshview.api.ScrollBoundaryDecider;
import com.refreshview.canstant.DimensionStatus;
import com.refreshview.canstant.RefreshState;
import com.refreshview.canstant.SpinnerStyle;
import com.refreshview.footer.ClassicsFooter;
import com.refreshview.header.ClassicsHeader;
import com.refreshview.impl.RefreshContentWrapper;
import com.refreshview.impl.RefreshFooterWrapper;
import com.refreshview.impl.RefreshHeaderWrapper;
import com.refreshview.listener.OnLoadMoreListener;
import com.refreshview.listener.OnMultiPurposeListener;
import com.refreshview.listener.OnRefreshListener;
import com.refreshview.listener.OnRefreshLoadMoreListener;
import com.refreshview.listener.OnStateChangedListener;
import com.refreshview.util.DelayedRunnable;
import com.refreshview.util.DensityUtil;
import com.refreshview.util.ScrollBoundaryUtil;
import com.refreshview.util.ViscousFluidInterpolator;
...
import static com.refreshview.util.DensityUtil.dp2px;
import static com.refreshview.util.SmartUtil.fling;
import static com.refreshview.util.SmartUtil.getColor;
import static com.refreshview.util.SmartUtil.isScrollableView;
...
public class SmartRefreshLayout extends ViewGroup implements RefreshLayout, NestedScrollingParent, NestedScrollingChild {
    ...
    protected boolean mDisableContentWhenRefresh = true;//是否开启在刷新时候禁止操作内容视图
    protected boolean mDisableContentWhenLoading = true;//是否开启在刷新时候禁止操作内容视图
...
//        this.mFooterExtendHeight = (int) Math.max((mFooterHeight * (mFooterMaxDragRate - 1)), 0);
     ...
     * 设置多功能监听器
     *
     * @param listener 建议使用 {@link com.refreshview.listener.SimpleMultiPurposeListener}
     * @return SmartRefreshLayout
     */
    @Override
     ...
     * 设置滚动边界
     *
     * @param boundary 建议使用 {@link com.refreshview.impl.ScrollBoundaryDeciderAdapter}
     * @return SmartRefreshLayout
     */
    @Override
